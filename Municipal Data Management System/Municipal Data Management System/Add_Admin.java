/*
 * Add_Admin.java - To add admin user to the the database.
			...
			try
			{
				...
				else
				{
					...
					else
					{
						...
						String str="insert into login_table values('"+username+"','"+password+"')";
						obj.s.executeUpdate(str);
						JOptionPane.showMessageDialog(null,"Insertation Sucessful");
						new Menu_Page();
						f.dispose();
					}
				}
